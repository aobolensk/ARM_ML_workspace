...
IMAGES_DIR = "imagenet"
TMP_DIR = "tmp"
SQUEEZENET_ASSETS_DIR = "squeezenet_assets"
...
def process_image(image_path: str):
    ...
    proc = subprocess.Popen([
        "ComputeLibrary/build/examples/graph_squeezenet",
        f"--image={ppm_path}",
        f"--data={SQUEEZENET_ASSETS_DIR}",
        f"--labels={os.path.join(SQUEEZENET_ASSETS_DIR, 'labels.txt')}",
        "--target=neon",
